Class: SubtleTransformer {#SubtleTransformer}
===============================
...
- SubtleTransformer requires the page to be in [Standards Mode](http://hsivonen.iki.fi/doctype/).
...
### Syntax:
	...
	var myThing = new SubtleTransformer([options]);
...
* (*object*) A new SubtleTransformer instance.
...
### Examples:
	...
	var myThing = new SubtleTransformer({
		optionl: 1,
		option8: true
	});
...
- SubtleTransformer - <http://demos.mootools.net/SubtleTransformer>
